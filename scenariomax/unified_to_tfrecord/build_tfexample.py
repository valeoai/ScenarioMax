...
from scenariomax.unified_to_tfrecord.converter.path import get_scenario_paths
from scenariomax.unified_to_tfrecord.converter.roadgraph import get_scenario_map_points
from scenariomax.unified_to_tfrecord.converter.scenario_analysis import classify_scenario, compute_variations
from scenariomax.unified_to_tfrecord.converter.state import get_state
from scenariomax.unified_to_tfrecord.converter.traffic_light import get_traffic_lights_state
from scenariomax.unified_to_tfrecord.converter.utils import get_object_trajectory
from scenariomax.unified_to_tfrecord.utils import AttrDict, bytes_feature, float_feature, int64_feature


logger = get_logger(__name__)


def build_tfexample(scenario_net_scene, debug=False):
    """
    ...
    state = get_state(scenario, debug)
    ...
    path_samples = get_scenario_paths(scenario, state, roadgraph_samples, debug)
