...
def get_scenarionet_type(obj_type):
    ...
    if ALL_TYPE[obj_type] == "barrier":
        _type = scenario_type.TRAFFIC_BARRIER
    elif ALL_TYPE[obj_type] == "trafficcone":
        _type = scenario_type.TRAFFIC_CONE
    elif obj_type in VEHICLE_TYPE:
        _type = scenario_type.VEHICLE
    elif obj_type in HUMAN_TYPE:
        _type = scenario_type.PEDESTRIAN
    elif obj_type in BICYCLE_TYPE:
        _type = scenario_type.CYCLIST

    # assert meta_type != scenario_type.UNSET and meta_type != "noise"
