...
from scenariomax.raw_to_unified.datasets.waymo.waymo_protos import keypoint_pb2 as scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_keypoint__pb2
...
Label = _reflection.GeneratedProtocolMessageType('Label', (_message.Message,), dict(
  ...
  Box = _reflection.GeneratedProtocolMessageType('Box', (_message.Message,), dict(
    ...
    __module__ = 'scenariomax.raw_to_unified.datasets.waymo.waymo_protos.label_pb2'
