...
from scenariomax.raw_to_unified.datasets.waymo.waymo_protos import compressed_lidar_pb2 as scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_compressed__lidar__pb2
...
ObjectState = _reflection.GeneratedProtocolMessageType('ObjectState', (_message.Message,), dict(
  ...
  __module__ = 'scenariomax.raw_to_unified.datasets.waymo.waymo_protos.scenario_pb2'
