...
# source: scenariomax/raw_to_unified/converter/waymo/waymo_protos/dataset.proto
...
_CONTEXT_STATS_OBJECTCOUNT.fields_by_name['type'].enum_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_label__pb2._LABEL_TYPE
...
_CAMERALABELS.fields_by_name['labels'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_label__pb2._LABEL
...
_FRAME.fields_by_name['laser_labels'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_label__pb2._LABEL
...
_FRAME.fields_by_name['no_label_zones'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_label__pb2._POLYGON2DPROTO
_FRAME.fields_by_name['map_features'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_map__pb2._MAPFEATURE
_FRAME.fields_by_name['map_pose_offset'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_vector__pb2._VECTOR3D
...
MatrixShape = _reflection.GeneratedProtocolMessageType('MatrixShape', (_message.Message,), dict(
  ...
  __module__ = 'scenariomax.raw_to_unified.datasets.waymo.waymo_protos.dataset_pb2'
...
CameraSegmentationLabel = _reflection.GeneratedProtocolMessageType('CameraSegmentationLabel', (_message.Message,), dict(

  InstanceIDToGlobalIDMapping = _reflection.GeneratedProtocolMessageType('InstanceIDToGlobalIDMapping', (_message.Message,), dict(
