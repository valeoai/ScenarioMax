...
# source: scenariomax/raw_to_unified/converter/waymo/waymo_protos/map.proto
...
Map = _reflection.GeneratedProtocolMessageType('Map', (_message.Message,), dict(
  DESCRIPTOR = _MAP,
  __module__ = 'scenariomax.raw_to_unified.converter.waymo.waymo_protos.map_pb2'
  # @@protoc_insertion_point(class_scope:waymo.open_dataset.Map)
  ))
_sym_db.RegisterMessage(Map)

DynamicState = _reflection.GeneratedProtocolMessageType('DynamicState', (_message.Message,), dict(
...
TrafficSignalLaneState = _reflection.GeneratedProtocolMessageType('TrafficSignalLaneState', (_message.Message,), dict(
...
BoundarySegment = _reflection.GeneratedProtocolMessageType('BoundarySegment', (_message.Message,), dict(
...
LaneNeighbor = _reflection.GeneratedProtocolMessageType('LaneNeighbor', (_message.Message,), dict(
...
RoadLine = _reflection.GeneratedProtocolMessageType('RoadLine', (_message.Message,), dict(
...
Driveway = _reflection.GeneratedProtocolMessageType('Driveway', (_message.Message,), dict(
