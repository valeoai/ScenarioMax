...
# source: scenariomax/raw_to_unified/converter/waymo/waymo_protos/keypoint.proto
...
_KEYPOINT2D.fields_by_name['location_px'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_vector__pb2._VECTOR2D
_KEYPOINT2D.fields_by_name['visibility'].message_type = _KEYPOINTVISIBILITY
_KEYPOINT3D.fields_by_name['location_m'].message_type = scenariomax_dot_raw__to__unified_dot_converter_dot_waymo_dot_waymo__protos_dot_vector__pb2._VECTOR3D
...
KeypointVisibility = _reflection.GeneratedProtocolMessageType('KeypointVisibility', (_message.Message,), dict(
  DESCRIPTOR = _KEYPOINTVISIBILITY,
  __module__ = 'scenariomax.raw_to_unified.converter.waymo.waymo_protos.keypoint_pb2'
...
CameraKeypoint = _reflection.GeneratedProtocolMessageType('CameraKeypoint', (_message.Message,), dict(
...
CameraKeypoints = _reflection.GeneratedProtocolMessageType('CameraKeypoints', (_message.Message,), dict(
...
LaserKeypoint = _reflection.GeneratedProtocolMessageType('LaserKeypoint', (_message.Message,), dict(
...
LaserKeypoints = _reflection.GeneratedProtocolMessageType('LaserKeypoints', (_message.Message,), dict(
